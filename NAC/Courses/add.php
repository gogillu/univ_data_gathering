          ...
          <form action="add_handler.php" method="POST" style="font-size:15px; border:solid 2px gray; width:600px; ">
            ...
            <?php
              ...
              $connection = mysqli_connect($servername, $username, $password, $dbname);
        	    $query = "Select * from programme where Uname like '".$_SESSION['username']."';";
            ...
            <input required style="height:40px; width:300px;" type="text" id="Course_code" name="Course_code" placeholder="COURSE CODE" value="<?php echo $_GET['cc']; ?>">

            <br>

            COURSE NAME &nbsp;

            <input required style="height:40px; width:300px;" type="text" id="Course_name" name="Course_name" placeholder="COURSE NAME" value="<?php echo $_GET['cn']; ?>">
