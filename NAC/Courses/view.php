...
<body class="BACK" onload="load_time_func();" style="font-family:ubuntu;">
    ...
    <center>
        ...
        <div class="col-sm-12"  style="margin-top:0px;">
            <br>
            <center><a style="color:black; ;;;; font-weight:normal; font-size:22px;">VIEW COURSES</a></center>
        </div>
        ...
        <div class="col-sm-12">
          ...
          <table border="2" style="padding:5px;">
            ...
            $query = "Select * FROM course WHERE Uname LIKE '".$_SESSION['username']."' ORDER BY Prog_code , Course_code";
            //echo $query."<br>";
            ...
            <tr style="font-weight:bold; font-size:16px;">
              ...
              <th style="width:250px;">Course Code</th>
              <th>Edit</th>
              <th>Remove</th>
            </tr>
            ...
            <tr id="<?php echo $row['Course_code']; ?>">
              ...
              <?php
              $query1 = "Select * FROM programme WHERE Uname LIKE '".$_SESSION['username']."' AND Prog_code LIKE '".$row['Prog_code']."'";
              //echo $query1."<br>";
