...
?>
    ...
    <center>
		...
		<input style="margin-right:10px; cursor:not-allowed;" <?php if($_SESSION['names']==""){ ?> disabled <?php } ?> type="button" onclick="location.href='Evaluation_report/sub_department.php';" value="EVALUATIVE REPORT"/>
		<input style="margin-right:10px; cursor:not-allowed;" <?php if($_SESSION['names']==""){ ?> disabled <?php } ?>  type="button" onclick="location.href='criteria9/c9.php';" value="EXTENDED PROFILE"/>
