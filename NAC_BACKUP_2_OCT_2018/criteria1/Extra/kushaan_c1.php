...
<body style="background-color:#E0E0E0;" onload="load_time_func();">

    
    
    <div class="container" style="width:100%; padding-bottom:20px; padding-top:20px; background-color:#424242">
        <div class="col-xs-3"></div>       
        
        <div class="col-xs-6">
            <div class="container " style="width:100%;">
                <div class="col-sm-2" class="x">
                    <img src="logo.png" alt="logo" style="width:95px; height:95px;">
                </div>
            
                <div class="col-sm-10" class="x">
                    <div style="font-size:26px; padding-top:16px; color:#FFF">Devi Ahilya Vishwavidyalaya, Indore</div>
                    <div style="font-size:18px; margin-top:5px; color:#FFF;">Information Gathering System 2017 - 2018</div>
                </div>
            </div>
...
<center>
    ...
    <div style="width:100%; padding:5px;  background-color:#616161">
        <span class="header" style="color:white; "><h3 style="font-size:16px;"> <?php echo strtoupper($_SESSION['name']);?>  </h3></span>
    </div>

    <br><br>
    
    <center><a style="color:black; ;;;; font-weight:bold; font-size:16px;">CRITERIA 1 - CURRICULAR ASPECTS</a></center>
...
-->
        ...
        <center><a style="color:black; ;;;; font-weight:normal; font-size:22px;">1.1 Curriculum Design and Development</a></center>
