...
<center>    
    <div class="col-sm-12" id="d132">
        ...
        function addRow132()
    	{
    		...
    		var html = '<tr id="'+i+'" ><td><center><select id="'+ip+'" onchange="fetch_course_code(this.value,this.id)" text="Programme Code" style="width:150px;" required></select></center></td><td><center><select id="'+ic+'" onchange="fetch_course_name(this.value,this.id)" text="Course Code" style="width:150px;" required></select></center></td><td><center><input id="'+icn+'" type="text" placeholder="Course Name" style="width:250px;" disabled></center></td><td><center><select id="'+ay+'" placeholder="Year Offering" style="width:170px;" required></select></center></td><td><center><input type="number" step="1" min="0" onkeypress="return event.charCode >= 48" placeholder="Number" style="width:80px;" required></center></td><td><center><select id="'+ay1+'" placeholder="Year Discontinued" style="width:170px;" required></select></center></td><td><center><input type="number" step="1" min="0" onkeypress="return event.charCode >= 48" style="width:80px;" placeholder="Number" required></center></td><td><center><input type="number" step="1" min="0" onkeypress="return event.charCode >= 48" style="width:80px;" placeholder="Number" required></center></td><td class="remove" style="width:40px;"><center><button onclick="remove_row(this);" type="button">Remove</button></center></td></tr>';
