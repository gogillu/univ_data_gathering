         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA4_1_1").value==""){
                                    ...
                                    document.getElementById("ch411").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet411.php?desc="+desc+"&link="+link , true);
         			   			 xhttp.send();
        		}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA4_1_2").value==""){
                                    ...
                                    document.getElementById("ch412").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet412.php?desc="+desc+"&link="+link, true);
         			   			 xhttp.send();
        		}
                ...
                var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               console.log(this.responseText);
									...
									xhttp.open("GET", "savet413.php?lcd="+lcd+"&lan="+lan+"&semi="+semi+"&totalc="+totalc+"&totals="+totals, true);
									xhttp.send();								}
...
<div class="col-sm-12" style="height:50px;">
    ...
    <div class="col-sm-12" onclick='rotate("tg413"); $("#d413").slideToggle("slow");'>
        ...
        <div id="h413" class="col-sm-10">
            <div class="col-sm-1"  style="font-size:18px;">4.1.3<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
...
<script>
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab414","ch414");
          			   			 ...
          			   			 xhttp.open("GET", "savet414.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <div class="col-sm-12" onclick='rotate("tg414"); $("#d414").slideToggle("slow");'>
        ...
        <div id="h414" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.1.4<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
...
<!-- 4.2.1-->
    <div class="col-sm-12" onclick='rotate("tg421"); $("#d421").slideToggle("slow");'>
        ...
        <div id="h423" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.2.1<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              ...
                              alert('Changes Saved Successfully');
                               ...
                               num_rows("tab421","ch421");
          			   			 ...
          			   			 xhttp.open("GET", "savet421.php?rows="+rowss, true);
         			   			 xhttp.send();
				}
...
<!-- 4.2.2 -->
    ...
    <div class="col-sm-12" onclick='rotate("tg422"); $("#d422").slideToggle("slow");'>
        ...
        <div id="h422" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.2.2<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              ...
                              alert('Changes Saved Successfully');
                               ...
                               num_rows("tab422","ch422");
          			   			 ...
          			   			 xhttp.open("GET", "savet422.php?rows="+rowss, true);
         			   			 xhttp.send();
				}
...
<script>
    	...
    	function addRow423()
    	{
            ...
            var html = '<tr id="'+i+'">'+mem+sub+name+eres+validityf+validityt+report+access+CR+'</tr>';
...
<!-- 4.2.3  -->		
        <div id="h423" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.2.3<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
        		...
        		if(rows.length == 20000) console.log("empty"); 
        			...
        			{	var choice_423= document.getElementById('choice_423').value;
        				...
        				if(yearOfIntro == "")
        				{
        					...
        					rowss += "('"+"<?php echo $_SESSION['username'];?>"+"','"+ mem + "','"+ sub + "','" +  name + "','" + eres + "','" + validityf + "','" + validityt + "','"+reportf + "','" + access +"','" + idd +"','" + choice_423 +"')";
        					if(i!=rows.length-2) rowss+= ",";
        					else rowss += ";";
        					console.log(rowss);
        				}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              ...
                              alert('Changes Saved Successfully');
                               ...
                               num_rows("tab423","ch423");
          			   			 ...
          			   			 xhttp.open("GET", "savet423.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
...
-->
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab424","ch424");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t4_2_4", true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <div class="col-sm-12" onclick='rotate("tg424"); $("#d424").slideToggle("slow");'>
        ...
        <div id="h424" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.2.4<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
...
<script>
        		...
        		if(rows.length == 20000) console.log("empty"); 
        			...
        			for(var i = 1; i < rows.length-1; i++)
        			{
        				...
        				}else
        				{
        					...
        					rowss += "('"+"<?php echo $_SESSION['username'];?>"+"','"+ ereso + "','"+ det + "','" +  raccess + "','" + idd +"')";
        					if(i!=rows.length-2) rowss+= ",";
        					else rowss += ";";
        					console.log(rowss);
        				}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              ...
                              alert('Changes Saved Successfully');
                               ...
                               num_rows("tab425","ch425");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t4_2_5", true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <div class="col-sm-12" onclick='rotate("tg425"); $("#d425").slideToggle("slow");'>
        ...
        <div id="h425" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.2.5<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
...
<center>
    <div class="col-sm-12" id="d425">
        ...
        function addRow425()
    	{
    		...
    		var html = '<tr id="'+i+'" ><td><center><input placeholder="e-resource" type="text" style="width:150px;" required></center></td><td><center><input  type="text" placeholder="Contact person details" style="width:250px;" ></center></td><td><center><input type="text" placeholder="Yes / No" style="width:165px;" required></center></td><td class="remove"><center><button onclick="remove_row(this);" type="button">Remove</button></center></td></tr>';
...
-->
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              ...
                              alert('Changes Saved Successfully');
                               ...
                               num_rows("tab426","ch426");
          			   			  ...
          			   			  xhttp.open("GET", "savet426.php?last="+last+"&method="+method+"&users="+users+"&teachers="+teachers+"&students="+students, true);
         			   			 xhttp.send();
			}
    ...
    <div class="col-sm-12" onclick='rotate("tg426"); $("#d426").slideToggle("slow");'>
        ...
        <div id="h426" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.2.6<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
...
<!--1.3.2-->
    ...
    <div class="col-sm-12" onclick='rotate("tg427"); $("#d427").slideToggle("slow");'>
        ...
        <div id="h427" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.2.7<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
...
<center>    
        		...
        		if(rows.length == 20000) console.log("empty"); 
        			...
        			for(var i = 1; i < rows.length-1; i++)
        			{
        				...
        				var idd = $(rows[i]).attr('id');		 
        					...
        					rowss += "('"+"<?php echo $_SESSION['username'];?>"+"','"+ teacher + "','"+  module + "','" + platform + "','" +  datel + "','"+  choice427 + "','" + idd +"')";
        					if(i!=rows.length-2) rowss+= ",";
        					else rowss += ";";
        					console.log(rowss);
        				}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab427","ch427");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t4_2_7", true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <form>
		...
		<td class="add"  colspan="4"><input class="add" type="image" src="../images/add2.png" onclick="addRow427()" alt="Submit" width="48" height="48"></td>	</tr>
        </table>
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA4_3_1").value==""){
                                    ...
                                    document.getElementById("ch431").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet431.php?desc="+x+"&link="+link, true);
         			   			 xhttp.send();
        		}
...
<!-- 4.3.2 -->
    ...
    <div class="col-sm-12" onclick='rotate("tg432"); $("#d432").slideToggle("slow");'>
        ...
        <div id="h432" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.3.2<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab432","ch432");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t4_3_2", true);
         			   			 xhttp.send();
        		}
        	}
...
<!-- 4.2.3  -->		
        <div id="h433" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.3.3<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              ...
                              alert('Changes Saved Successfully');
                               ...
                               //num_rows("tab433","ch433");
          			   			 ...
          			   			 xhttp.open("GET", "savet433.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
...
<!-- /4.2.3 -->	
    ...
    <div class="col-sm-12" onclick='rotate("tg434"); $("#d434").slideToggle("slow");'>
        ...
        <div id="h434" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>4.3.4<br><br>Q<sub>L</sub>M</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab434","ch434");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t4_3_4", true);
         			   			 xhttp.send();
        		}
        	}
...
<script>
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab441","ch441");
          			   			 ...
          			   			 xhttp.open("GET", "savet441.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <div class="col-sm-12" onclick='rotate("tg441"); $("#d441").slideToggle("slow");'>
        ...
        <div id="h441" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;">4.4.1<br><br>Q<sub>L</sub>M</div>
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA4_4_2").value==""){
                                    ...
                                    document.getElementById("ch442").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet442.php?desc="+x+"&link="+link, true);
         			   			 xhttp.send();
        		}
...
<!-- jain edits -->
	...
	$query = "Select * from t4_1_1 where Uname like '".$_SESSION['username']."';";
...
?>
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t4_1_2 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t4_2_6 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t4_3_3 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t4_2_3 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t4_4_2 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
        ...
        // 5.4.1
            document.getElementById("TA4_4_2").value = '<?php echo $row["Description"]; ?>';
            document.getElementById("link4_4_2").value = '<?php echo $row["Link"]; ?>';
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t4_3_1 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
        ...
        // 4.3.1
            document.getElementById("TA4_3_1").value = '<?php echo $row["Description"]; ?>';
            document.getElementById("link4_3_1").value = '<?php echo $row["Link"]; ?>';
