        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab511","ch511");
          			   			 ...
          			   			 xhttp.open("GET", "savet511.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab512","ch512");
          			   			 ...
          			   			 xhttp.open("GET", "savet512.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab513","ch513");
          			   			 ...
          			   			 xhttp.open("GET", "savet513.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab514","ch514");
          			   			 ...
          			   			 xhttp.open("GET", "savet514.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA5_1_5").value==""){
                                    ...
                                    document.getElementById("ch515").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet515.php?desc="+ta+"&link="+link, true);
         			   			 xhttp.send();
        		}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab516","ch516");
          			   			 ...
          			   			 xhttp.open("GET", "savet516.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab521","ch521");
          			   			 ...
          			   			 xhttp.open("GET", "savet521.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab522","ch522");
          			   			 ...
          			   			 xhttp.open("GET", "savet522.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab523","ch523");
          			   			 ...
          			   			 xhttp.open("GET", "savet523.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab531","ch531");
          			   			 ...
          			   			 xhttp.open("GET", "savet531.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab533","ch533");
          			   			 ...
          			   			 xhttp.open("GET", "savet533.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA5_4_1").value==""){
                                    ...
                                    document.getElementById("ch541").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet541.php?desc="+ta+"&link="+link, true);
         			   			 xhttp.send();
        		}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab542","ch542");
          			   			 ...
          			   			 xhttp.open("GET", "savet542.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
...
<center>
		...
		<option value="">Select</option>
		<option value="100 Lakhs">≥ 100 Lakhs</option>
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab543","ch543");
          			   			 ...
          			   			 xhttp.open("GET", "savet543.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
...
<?php            
	...
	$query = "Select * from t5_3_2 where Uname like '".$_SESSION['username']."';";
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t5_1_5 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
        ...
        // 1.3.1
            document.getElementById("TA5_1_5").value = '<?php echo $row["Description"]; ?>';
            document.getElementById("link5_1_5").value = '<?php echo $row["Link"]; ?>';
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t5_4_1 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
        ...
        // 5.4.1
            document.getElementById("TA5_4_1").value = '<?php echo $row["Description"]; ?>';
            document.getElementById("link5_4_1").value = '<?php echo $row["Link"]; ?>';
