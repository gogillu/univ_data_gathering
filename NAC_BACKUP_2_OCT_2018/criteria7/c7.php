        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab711","ch711");
          			   			 ...
          			   			 xhttp.open("GET", "savet711.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA4_1_2").value==""){
                                    ...
                                    document.getElementById("ch412").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet712.php?desc="+desc+"&link="+link, true);
         			   			 xhttp.send();
        		}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              alert('Changes Saved Successfully');
                               ...
                               console.log(this.responseText);
									...
									xhttp.open("GET", "savet713.php?lcd="+powerreq+"&lan="+powert+"&semi="+ren+"&totalc="+reng+"&totals="+es, true);
									xhttp.send();								}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              alert('Changes Saved Successfully');
                               ...
                               console.log(this.responseText);
									...
									xhttp.open("GET", "savet714.php?lcd="+powerreq+"&lan="+powert+"&semi="+ren, true);
									xhttp.send();								}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA7_1_5").value==""){
                                    ...
                                    document.getElementById("ch715").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet715.php?desc="+desc+"&link="+link, true);
         			   			 xhttp.send();
        		}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA7_1_6").value==""){
                                    ...
                                    document.getElementById("ch716").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet716.php?desc="+desc+"&link="+link, true);
         			   			 xhttp.send();
        		}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA7_1_7").value==""){
                                    ...
                                    document.getElementById("ch717").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet717.php?desc="+desc+"&link="+link, true);
         			   			 xhttp.send();
        		}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab718","ch718");
          			   			 ...
          			   			 xhttp.open("GET", "savet718.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                              ...
                              alert('Changes Saved Successfully');
                               ...
                               num_rows("tab719","ch719");
          			   			 ...
          			   			 xhttp.open("GET", "savet719.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab7110","ch7110");
          			   			 ...
          			   			 xhttp.open("GET", "savet7110.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab7111","ch7111");
          			   			 ...
          			   			 xhttp.open("GET", "savet7111.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
                ...
                var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               console.log(this.responseText);
									...
									xhttp.open("GET", "savet7112.php?lcd="+lcd+"&lan="+lan, true);
									xhttp.send();								}
                ...
                var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               console.log(this.responseText);
									...
									xhttp.open("GET", "savet7113.php?lcd="+lcd+"&lan="+lan, true);
									xhttp.send();								}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab7114","ch7114");
          			   			 ...
          			   			 xhttp.open("GET", "savet7114.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
                ...
                var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               console.log(this.responseText);
									...
									xhttp.open("GET", "savet7115.php?lcd="+lcd+"&lan="+lan, true);
									xhttp.send();								}
                ...
                var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               console.log(this.responseText);
									...
									xhttp.open("GET", "savet7116.php?lcd="+lcd+"&lan="+lan, true);
									xhttp.send();								}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab7117","ch7117");
          			   			 ...
          			   			 xhttp.open("GET", "savet7117.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA7_1_18").value==""){
                                    ...
                                    document.getElementById("ch7118").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet7118.php?desc="+vu+"&link="+link, true);
         			   			 xhttp.send();
        		}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA7_1_19").value==""){
                                    ...
                                    document.getElementById("ch7119").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet7119.php?desc="+vu+"&link="+link, true);
         			   			 xhttp.send();
        		}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_tabs("Tabs721","ch721");
          			   			 ...
          			   			 xhttp.open("GET", "savet721.php?rows="+Tabss, true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab721","ch721");
          			   			 ...
          			   			 xhttp.open("GET", "savet721.php?rows="+rowss, true);
         			   			 xhttp.send();
        		}
        	}
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               if(document.getElementById("TA7_3_1").value==""){
                                    ...
                                    document.getElementById("ch731").innerHTML = '<img src="../images/filled.png" width="58" height="58"> Filled';
          			   			 ...
          			   			 xhttp.open("GET", "savet731.php?desc="+vu+"&link="+link, true);
         			   			 xhttp.send();
        		}
...
?>
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_2 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
...
<!-- 7.1.5 -->
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_5 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
 ...
 <?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_7 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
 ...
 <!--  7.1.7 -->
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_6 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];?>
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_3 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_4 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_12 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_16 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_13 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_3_1 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_19 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_18 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>
...
<?php            
    ...
    $connection = mysqli_connect($servername, $username, $password, $dbname);
	$query = "Select * from t7_1_15 where Uname like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query) or die(mysqli_error($connection));
    $row  = $res ->fetch_assoc();        
            //echo $row['Description'];
?>       
